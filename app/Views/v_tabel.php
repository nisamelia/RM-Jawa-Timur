            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if (auth()->loggedIn()) : ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#><i class=" fa-solid fa-table-list"><i class="fa-solid fa-table-list"></i> Tabel</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container my-4">
        ...
        <div class="card">
            <div class="card-header">
                <h2><i class="fa-solid fa-table-list"></i> Tabel Data Objek</h2>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        foreach ($dataobjek as $d) : ?>
                            <tr>
                                ...
                                <!-- //kalau eror bisa ditambahkan .'/'. sebelum $d -->
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
